<template>
  ...
  <section id="page-content" class="container">
    <div class="row">
      <div class="col-lg-6">
        <div class="text-center" v-if="!carts.total == 0">
          ...
          >
            <div class="mb-3">
              <label for="name" class="form-label"
                ><span class="text-danger me-1">*</span>訂購人姓名</label
              >
              <VField
                id="name"
                name="姓名"
            ...
            <div class="mb-3">
              <label for="tel" class="form-label"
                ><span class="text-danger me-1">*</span>訂購人電話</label
              >
              <VField
                id="tel"
                name="電話"
            ...
            <div class="mb-3">
              <label for="address" class="form-label"
                ><span class="text-danger me-1">*</span>訂購人地址</label
              >
              <VField
                id="address"
                name="地址"
