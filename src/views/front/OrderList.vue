            ...
            <div class="row">
              <div class="col-lg-6">
                ...
                <div class="mb-2">
                  ...
                  <div
                    v-for="item in orderResult.products"
                    :key="item.id"
                    class="px-3 py-2 bg-light border-bottom"
                  >
              ...
              <div class="col-lg-6">
                ...
                <ul class="border">
                  <li class="p-2 me-3 border-bottom">
                    姓名：{{ orderUser.name }}
                  </li>
                  <li class="p-2 me-3 border-bottom">
                    電話：{{ orderUser.tel }}
...
export default {
  ...
  methods: {
    ...
    searchOrder() {
      const result = this.orders.filter((item) => this.orderNum === item.id);
      const nowTime = new Date(result[0].create_at * 1000);
      const newYear = nowTime.getFullYear();
      const newMonth = nowTime.getMonth() + 1;
      const newDay = nowTime.getDate();
      const newHour = nowTime.getHours();
      const newMinute = nowTime.getMinutes();
